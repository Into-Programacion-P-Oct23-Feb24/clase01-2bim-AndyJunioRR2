...
public class Ejemplo07 {
    public static void main(String[] args) {
        ...
        for (int i = 1; i <= 50; i++) { // for 01
            // contador que indica hasta que tabla de multiplicar queramos
            //tener
            ...
            for (int contador = 1; contador <= 12; contador++) {
                ...
                // Contador para el limite de la tabla
            ...
            /* se agregra el mensaje final "%s\n" para poder dar un espacio entre
